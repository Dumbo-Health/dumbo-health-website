    ...
    <>
      ...
      <section className="bg-daylight py-16 sm:py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading text-2xl md:text-4xl lg:text-hero text-midnight text-center mb-12">
      ...
      <section className="bg-sunlight py-12 sm:py-16">
        <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-heading text-h3 text-midnight mb-2">
            Are you already a Dumbo Health Patient?
          </h2>
          <p className="font-body text-body text-midnight/70 mb-6">
      ...
      <section className="bg-daylight py-16 sm:py-24">
        <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="font-heading text-h2 text-midnight mb-2">Let&apos;s talk!</h2>
            <h3 className="font-heading text-h3 text-midnight/70 mb-2">Tell us what you need</h3>
            <p className="font-body text-body text-midnight/70">Write to us, we&apos;re here to help</p>
          </div>
          <ContactForm />
        </div>
      </section>
