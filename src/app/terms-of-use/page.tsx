  ...
  return (
    ...
    <article className="bg-daylight py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="font-mono text-xs text-midnight/50 mb-4">Last Updated: 12/17/2025</p>
        <div className="bg-peach/10 border border-peach/30 rounded-lg p-4 mb-12">
          <p className="font-body text-base font-bold text-midnight">
        ...
        <div className="prose prose-lg max-w-none font-body text-midnight/80 space-y-8">
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">1. Services — No Medical Care</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">2. Not for Emergencies</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">3. Risk of Services</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">4. Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">5. Prescription Practices</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">6. Not Insurance</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">7. IP Ownership</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">9. Access & Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">10. Age Requirement</h2>
            <p>You must be at least 18 years old to use our services.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">11. Your Account</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">12. Information Accuracy</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">13. Pricing Errors</h2>
            <p>We may refuse purchases at incorrect prices.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">14. DMCA</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">15. Online Payments</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">16. Purchase Acceptance</h2>
            <p>We may refuse or cancel purchases at our discretion.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">17. Third-Party Links</h2>
            <p>We are not responsible for third-party websites.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">18. Communications Consent</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">19. CAN-SPAM & TCPA Compliance</h2>
            <p>We strive to comply with CAN-SPAM and TCPA regulations.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">20. Electronic Signatures</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">21. External Services</h2>
            <p>Third-party services are used at your own risk.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">22. Provider Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">23. No Third-Party Rights</h2>
            <p>Third parties cannot rely on platform benefits.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">24. Arbitration</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">25. Indemnification</h2>
            <p>Users agree to defend and indemnify Dumbo Health.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">26. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">27. Limitation of Liability</h2>
            <p>Maximum aggregate liability is $500.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">28. Force Majeure</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">29. Copyright & Trademark</h2>
            <p>&copy; 2025 Dumbo Health, Inc. All rights reserved.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">30. Revisions</h2>
            <p>We may terminate access and revise these terms at any time.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-medium text-midnight">31. Contact</h2>
            <p>
