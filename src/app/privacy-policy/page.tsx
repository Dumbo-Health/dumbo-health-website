  ...
  return (
    ...
    <article className="bg-daylight py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="font-mono text-tag text-midnight/50 mb-12">Last Modified: 01/08/2026</p>

        <div className="prose prose-lg max-w-none font-body text-midnight/80 space-y-8">
          <section>
            <h2 className="font-heading text-h3 text-midnight">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">2. No Children Under 13</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">3. Information Collection</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">4. How Information Is Used</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">5. SMS Communications</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">6. Disclosure</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">7. User Choices</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">9. Do Not Track</h2>
            <p>Our website is not designed to honor Do Not Track signals.</p>
          </section>

          <section>
            <h2 className="font-heading text-h3 text-midnight">10. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">11. Third-Party Sites</h2>
            <p>We are not responsible for third-party privacy practices.</p>
          </section>

          <section>
            <h2 className="font-heading text-h3 text-midnight">12. Changes</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-midnight">13. Contact</h2>
            <p>
