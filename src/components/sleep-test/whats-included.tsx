...
const INCLUDED = [
  {
    ...
    detail: "Single-use, wrist-worn, FDA-cleared. Validated for home sleep studies.",
  },
  {
  ...
  },
  {
    ...
    label: "Doctor-reviewed results",
    detail: "A sleep physician reads your overnight data and signs off on your report.",
  },
  {
    icon: "/images/icons/icon-clock.png",
    label: "Results in 48 hours",
    detail: "Your full sleep report, including AHI (breathing pauses per hour), delivered within two days.",
  },
  {
    icon: "/images/icons/icon-arrows.png",
    label: "Prescription included",
    detail: "Confirmed diagnosis? Your prescription comes with the report. No extra appointment needed.",
  },
  {
    icon: "/images/icons/icon-laptop.png",
    label: "Free shipping",
    detail: "Ships to you at no extra cost. Single-use device, nothing to return.",
  },
];
    ...
    >
      <div style={{ padding: "0 5%" }}>
        ...
        <div className="text-center" style={{ maxWidth: "580px", margin: "0 auto 3.5rem" }}>
          ...
          >
            WatchPAT ONE · everything included
          </motion.p>
          <motion.h2
