...
const STEPS = [
  {
    ...
    body: "Answer a short medical questionnaire after ordering. Our physicians review it before your kit ships. It's how we confirm the test is right for you and get a physician in your corner from day one.",
  },
  {
    number: "02",
    title: "Wear it one night",
    body: "The WatchPAT ONE attaches to your wrist and finger. Comfortable enough to fall asleep in. No lab, no technician, no unfamiliar bed.",
  },
  {
    number: "03",
    title: "Get your results",
    body: "A board-certified sleep physician reviews your overnight data. You receive a detailed report within 48 hours, with a prescription included if sleep apnea is confirmed.",
  },
  {
    number: "04",
    title: "Start treatment",
    body: "If sleep apnea is confirmed, we help you get started with CPAP therapy, a dental appliance for sleep apnea, or ongoing monitoring. All through Dumbo Health, all in one place.",
  },
];
