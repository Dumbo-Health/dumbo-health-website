  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{ top: "50%", transform: "translateY(-50%)", opacity: 0.05, zIndex: 0 }}
      />
      ...
      >
        ...
        >
          Don&apos;t wait for your medical deadline.
        </motion.p>
        ...
        >
          Free shipping · HIPAA compliant · Board-certified physicians · Results in 48 hours
        </motion.p>
      </div>
    </section>
  );
