...
export function DotAfterPositive() {
  return (
    <section
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(255,131,97,0.08) 0%, transparent 65%)",
          zIndex: 0,
        }}
      />
      ...
      >
        ...
        >
          For positive diagnoses · CDL drivers
        </motion.p>
        ...
        >
          Test positive? CPAP is required.{" "}
        ...
        >
          A positive result means CPAP therapy is mandatory for DOT
          re-certification. We set up your therapy, monitor your nightly usage,
          and generate the 30-day compliance report your examiner needs. Your
              ...
              >
                {item.icon && (
                  <div
                    ...
                    style={{ width: 32, height: 32, backgroundColor: "rgba(255,131,97,0.1)" }}
                  >
                    <Image src={item.icon} alt="" width={18} height={18} style={{ objectFit: "contain" }} />
                  </div>
                )}
                <p
        ...
        >
          First month discount applies to any CPAP subscription plan. Applied
